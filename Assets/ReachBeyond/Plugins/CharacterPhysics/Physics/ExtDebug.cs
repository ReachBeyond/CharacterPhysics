// This file comes from HiddenMonk:
// https://answers.unity.com/answers/1156088/view.html
// TODO make this use UnityEngine.Gizmos instead of all this... line stuff.
//      That way, we are the actual authors as well, and it's probably more
//      efficient... not that debug stuff needs to be all to efficient.
//
// As such, they are free to request that this gets removed from future versions
// of the project. It's unlikely that the individual will mind their code
// getting used here, but they have the option to have it removed.
//
// Obviously, for that reason, this can't really be covered by the LGPL without
